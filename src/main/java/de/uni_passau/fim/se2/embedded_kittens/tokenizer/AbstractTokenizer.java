...
abstract class AbstractTokenizer
    ...
    protected AbstractTokenizer(
        ...
        Preconditions.checkNotNull(maskingStrategy);
        this.maskingStrategy = maskingStrategy;
    }

    protected void addToken(final Token opcode) {
        tokens.add(opcode.getStrRep());
    }

    protected void addToken(final AbstractToken token) {
    ...
    protected MaskingStrategy getMaskingStrategy() {
        return this.maskingStrategy;
    }

    public boolean isAbstractTokens() {
